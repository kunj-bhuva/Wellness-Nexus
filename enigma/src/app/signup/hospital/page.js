                                    ...
                                    <div class="lg:col-span-2">
                                        <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                            <div class="md:col-span-5">
                                                ...
                                                <input value={name} onChange={(e) => Setname(e.target.value)} type="text" name="full_name" id="full_name" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50"  placeholder="Anand Hospital" />
                                            </div>
                                            ...
                                            <div class="md:col-span-5">
                                                ...
                                                <input value={password} onChange={(e) => Setaddress(e.target.value)} type="text" name="password" id="password" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50"   placeholder="Enter your password " />
                                            </div>
