...
<button
  class="text-white py-2 px-4  uppercase rounded-xl bg-green-400 hover:bg-green-500 shadow hover:shadow-lg font-medium transition transform hover:-translate-y-0.5"
>
  Accept
</button>
    <button
  class="text-white py-2 px-4 uppercase rounded-xl bg-red-700 hover:bg-red-800 shadow hover:shadow-lg font-medium transition transform hover:-translate-y-0.5"
>
  Reject
</button>
    </div>
  ...
  <div class="mt-20 text-center border-b pb-8">
    ...
    <p class="mt-8 text-black text-2xl font-semibold">Title of Request</p>
	<p>Type of Doctor: Ortheopadic</p>
	<p>Medium: Call</p>
	</div>
